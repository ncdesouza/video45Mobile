package com.video45.video.decoder;
...
public class Decoder extends MediaCodec.Callback {
    ...
    public Decoder(Context context, Surface surface, Uri video) throws IOException, CodecNotFoundException {
    ...
    class CodecNotFoundException extends Exception {
